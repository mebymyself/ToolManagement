class Account < ActiveRecord::Base
	...
	sub8 = %w(tool tools toolhero toolheros equipment equipments testing price pricing validate android example login)

	subdomain = sub1 + sub2 + sub3 + sub4 + sub5 + sub6 + sub7 + sub8

	RESTRICTED_SUBDOMAINS = subdomain
